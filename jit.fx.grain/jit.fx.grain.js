...
slab.file = "jit.fx.grain.jxs";
slab.inputs = 1;

var _grain_size = 2.5;
var _grain_amount = 0.25;
var _colored = 1;
var _luma_amount = 1;
var _color_tint = 0.7;

function grain_size(){ _grain_size = arguments[0]; slab.param("grain_size", _grain_size);}
function grain_amount(){ _grain_amount = arguments[0]; slab.param("grain_amount", _grain_amount);}
function colored(){ _colored = arguments[0]; slab.param("colored", _colored);}
function luma_amount(){ _grain_size = arguments[0]; slab.param("luma_amount", _luma_amount);}
function color_tint(){ _color_tint = arguments[0]; slab.param("color_tint", _color_tint);}
