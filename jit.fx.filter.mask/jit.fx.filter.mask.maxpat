...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 294.0, 266.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 177.0, 195.0, 29.5, 22.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 175.0, 108.0, 41.0, 22.0 ],
									"text" : "length"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 50.0, 42.0, 22.0 ],
									"text" : "snorm"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 294.0, 133.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 294.0, 175.0, 149.0, 22.0 ],
					"text" : "jit.matrix 1 float32 300 200"
				}
...
, 			{
				"box" : 				{
					"filename" : "jit.fx.filter.mask.js",
					"id" : "obj-72",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 285.0, 115.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "v8 jit.fx.filter.mask.js",
					"textfile" : 					{
						"filename" : "jit.fx.filter.mask.js",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"name" : "jit.fx.filter.mask.js",
				"bootpath" : "~/Documents/GitHub/jit.fx/jit.fx.filter.mask",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
