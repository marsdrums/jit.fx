...
, 			{
				"box" : 				{
					"filename" : "jit.fx.analysis.max.js",
					"id" : "obj-72",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.0, 147.0, 131.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "v8 jit.fx.analysis.max.js",
					"textfile" : 					{
						"filename" : "jit.fx.analysis.max.js",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"name" : "jit.fx.analysis.max.js",
				"bootpath" : "~/Documents/GitHub/jit.fx/jit.fx.analysis.max",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
