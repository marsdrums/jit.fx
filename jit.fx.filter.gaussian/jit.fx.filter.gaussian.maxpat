...
, 			{
				"box" : 				{
					"filename" : "jit.fx.filter.gaussian.js",
					"id" : "obj-72",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 285.0, 135.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "v8 jit.fx.filter.gaussian.js",
					"textfile" : 					{
						"filename" : "jit.fx.filter.gaussian.js",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"name" : "jit.fx.filter.gaussian.js",
				"bootpath" : "~/Documents/GitHub/jit.fx/jit.fx.filter.gaussian",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
