...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 194.0, 76.0, 22.0 ],
					"text" : "prepend hue"
				}
...
, 			{
				"box" : 				{
					"filename" : "jit.fx.hue.js",
					"id" : "obj-72",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 252.0, 81.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "v8 jit.fx.hue.js",
					"textfile" : 					{
						"filename" : "jit.fx.hue.js",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"name" : "jit.fx.hue.js",
				"bootpath" : "~/Documents/GitHub/jit.fx/jit.fx.hue",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
