...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 157.0, 33.0, 22.0 ],
									"text" : "- 0.5"
								}
...
,
					"patching_rect" : [ 54.0, 140.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					"filename" : "jit.fx.op.abs.jxs",
					"id" : "obj-72",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 54.0, 185.0, 226.0, 22.0 ],
					"text" : "jit.gl.slab @file jit.fx.op.abs.jxs @inputs 1",
					"textfile" : 					{
						"filename" : "jit.fx.op.abs.jxs",
						"flags" : 0,
						"embed" : 0,
