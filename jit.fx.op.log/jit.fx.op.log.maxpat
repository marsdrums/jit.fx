...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.0, 137.0, 30.0, 20.0 ],
					"text" : "* 3"
				}
...
,
					"patching_rect" : [ 56.0, 136.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					"filename" : "jit.fx.op.log.jxs",
					"id" : "obj-72",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 54.0, 176.0, 222.0, 22.0 ],
					"text" : "jit.gl.slab @file jit.fx.op.log.jxs @inputs 1",
					"textfile" : 					{
						"filename" : "jit.fx.op.log.jxs",
						"flags" : 0,
						"embed" : 0,
